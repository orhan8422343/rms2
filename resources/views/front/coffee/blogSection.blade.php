<section class="blog-area blog-3 pb-70">
    <div class="container">
        <div class="row">
            ...
            <a href="{{ route('front.blogs') }}" class="btn btn-lg btn-primary rounded-pill" type="button" aria-label="Read Now">{{ __('Read More') }}</a> 
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up">
                        <article class="card mb-30 radius-md p-20">
                            <div class="card-img">
                                <a href="{{ route('front.blogdetails', [$blog->slug, $blog->id]) }}" target="_self" title="Link"
                                    class="lazy-container ratio ratio-5-3">
                                    <img class="lazyload" src="{{ asset('assets/front/img/blogs/' . $blog->main_image) }}"
                            ...
                            <div class="card-content">
                                <ul
                                    ...
                                    @if ($blog->bcategory)
                                    <li class="icon-start">
                                        <a href="{{ route('front.blogs', ['category' => $blog->bcategory->id]) }}" target="_self" title="{{ $blog->bcategory ? $blog->bcategory->name : '' }}"><i
                                ...
                                <a href="{{ route('front.blogdetails', [$blog->slug, $blog->id]) }}" class="btn-text color-primary font-lg" target="_self"
