            ...
            <div class="col-lg-8">
              <div class="form-group">
                  ...
                  <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="role_type" id="waiter" value="waiter">
                      <label class="form-check-label" for="waiter">Waiter</label>
                  </div>
                  <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="role_type" id="casher" value="casher">
                      <label class="form-check-label" for="casher">Casher</label>
                  </div>
                  <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="role_type" id="delivery" value="delivery">
