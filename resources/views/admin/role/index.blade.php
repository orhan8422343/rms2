...
@section('content')
  <div class="page-header">
    <h4 class="page-title">المسؤولين</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">إدارة الصلاحيات</div>
          <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i>إضافة صلاحية</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
