                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="showImage mb-3">
                                                ...
                                                @endif
                                                <img src="{{ !empty($abe->hero_bg) ? asset('assets/front/img/' . $abe->hero_bg) : asset('assets/admin/img/noimage.jpg') }}"
                                                ...
                                                <div class="showImage mb-3">
                                                    @if (!empty($abe->hero_side_img))
                                                        <a class="remove-image" data-type="side"><i
                                                                class="far fa-times-circle"></i></a>
                                                    @endif
                                                    <img src="{{ !empty($abe->hero_side_img) ? asset('assets/front/img/' . $abe->hero_side_img) : asset('assets/admin/img/noimage.jpg') }}"
                                                        alt="..." class="img-thumbnail w-100">
                                                </div>
                                                ...
                                                <div class="showImage mb-3">
                                                    @if (!empty($abe->hero_bottom_img))
                                                        <a class="remove-image" data-type="bottom"><i
                                                                class="far fa-times-circle"></i></a>
                                                    @endif
                                                    <img src="{{ !empty($abe->hero_bottom_img) ? asset('assets/front/img/' . $abe->hero_bottom_img) : asset('assets/admin/img/noimage.jpg') }}"
                                                        alt="..." class="img-thumbnail w-100">
                                                </div>
                                                ...
                                                <div class="showImage mb-3">
                                                    @if (!empty($abe->hero_shape_img))
                                                        <a class="remove-image" data-type="shape"><i
                                                                class="far fa-times-circle"></i></a>
                                                    @endif
                                                    <img src="{{ !empty($abe->hero_shape_img) ? asset('assets/front/img/' . $abe->hero_shape_img) : asset('assets/admin/img/noimage.jpg') }}"
                                                        alt="..." class="img-thumbnail w-100">
                                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="hero_section_background_text" class="form-control"
                                                value="{{ $abe->hero_section_water_shape_text }}" placeholder="Hero Section Background Text">
                                            <p id="errhero_section_background_text" class="em text-danger mb-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">Background Text Font Size(if there is Backgraound Text **)</label>
                                            <input type="number" class="form-control ltr"
                                                name="hero_section_background_text_font_size"
                                                value="{{ $abe->hero_section_water_shape_text && $abe->hero_section_water_shape_text_font_size ?  $abe->hero_section_water_shape_text_font_size :'' }}" placeholder="Hero Section Background Text Font Size" > 
                                            <p id="errhero_section_background_text_font_size" class="em text-danger mb-0"></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="showImage mb-3">
                                                    @if (!empty($abe->hero_section_author_image))
                                                        <a class="remove-image" data-type="author"><i
                                                                class="far fa-times-circle"></i></a>
                                                    @endif
                                                    <img src="{{ !empty($abe->hero_section_author_image) ? asset('assets/front/img/' . $abe->hero_section_author_image) : asset('assets/admin/img/noimage.jpg') }}"
                                                        alt="..." class="img-thumbnail w-100">
                                                </div>
