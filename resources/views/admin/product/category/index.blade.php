...
@section('content')
  <div class="page-header">
    <h4 class="page-title">أصناف الطعام</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-title d-inline-block">الأصناف</div>
                </div>
                {{-- <div class="col-lg-3">
                    @if (!empty($langs))
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i>إضافة صنف</a>
          ...
          <div class="row">
            <div class="col-lg-12">
              @if (count($pcategories) == 0)
                <h3 class="text-center">لم يتم إضافة أي صنف</h3>
              @else
                        ...
                        <tr>
                          ...
                          <td>
                            @if ($category->status == 1)
                              <h2 class="d-inline-block"><span class="badge badge-success">موجود</span></h2>
                            @else
                              <h2 class="d-inline-block"><span class="badge badge-danger">غير موجود</span></h2>
                            @endif
                          </td>
                          <td>
                              <form id="featureForm{{$category->id}}" action="{{route('admin.pcategory.feature')}}" method="POST">
                                  ...
                                  " onchange="document.getElementById('featureForm{{$category->id}}').submit();">
                                      <option value="1" {{$category->is_feature == 1 ? 'selected' : ''}}>عرض</option>
                                      <option value="0" {{$category->is_feature == 0 ? 'selected' : ''}}>إخفاء</option>
                                  </select>
                              </form>
                          </td>
                          <td>
