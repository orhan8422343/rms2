...
@section('content')
  <div class="page-header">
    <h4 class="page-title">النسخ الإحتياطي</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">قائمة النسخ الإحتياطية</div>
          <form class="d-inline-block float-right" action="{{route('admin.backup.store')}}" method="post">
            @csrf
            <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i>إنشاء نسخة إحتياطية</button>
          </form>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              ...
              @if (count($backups) == 0)
                <h3 class="text-center">ليس هناك أي نسخة إحتياطية</h3>
              @else
                <div class="table-responsive">
                  <table class="table table-striped mt-3">
                    <thead>
                      <tr>
                        <th scope="col">تاريخ النسخة الإحتياطية</th>
