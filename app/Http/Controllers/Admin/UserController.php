...
class UserController extends Controller
{
    ...
    public function store(Request $request) {
      ...
      $input['password'] = bcrypt($request['password']);
              // Set role type based on selected radio button
    ...
    public function update(Request $request) {
      ...
      switch ($request->input('role_type')) {
        case 'waiter':
            $input['is_waiter'] = 1;
            $input['is_casher'] = $input['is_delivery'] = 0;
            break;
        case 'casher':
            $input['is_casher'] = 1;
            $input['is_waiter'] = $input['is_delivery'] = 0;
            break;
        case 'delivery':
            $input['is_delivery'] = 1;
            $input['is_waiter'] = $input['is_casher'] = 0;
            break;
        default:
            $input['is_waiter'] = $input['is_casher'] = $input['is_delivery'] = 0;
            break;
    }
